...
@implementation HLLFileTool

#pragma mark -- life cycle
static HLLFileTool *shared = nil;
...
- (NSURL *)pathForFolderPath:(NSString *)folderPath
    ...
    NSArray <NSString *> *sourceFilePaths = [[HLLFileTool shareInstence] quesryNameOfChildFilesAtFolderPath:folderPath extendType:@".txt"];
    [sourceFilePaths enumerateObjectsUsingBlock:^(NSString * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        if (obj) {
